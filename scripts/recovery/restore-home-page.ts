...
const HOME_PAGE_CONTENT = [
  ...
  // -------------------------------------------------------------------------
  // SECTION 2: CK Editor Content (MISSING - needs adding)
  // -------------------------------------------------------------------------
  {
    __component: "utilities.ck-editor-content",
    content: `<h3 style="text-align:center;">🚀 Kickstart your project development&nbsp;</h3><p style="text-align:center;"><span style="color:var(--color-muted-foreground);">Build Faster with the Ultimate Monorepo Starter for Strapi &amp; Next.js</span></p>`,
  },
