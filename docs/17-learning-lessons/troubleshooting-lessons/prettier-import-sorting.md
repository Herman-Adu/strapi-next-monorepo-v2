...
<!-- VALUE: Cross-platform Prettier debugging methodology (5+ hours investigation) -->
<!-- DATE ARCHIVED: December 2025 -->
<!-- REASON: Demonstrates Windows/Linux compatibility debugging, AST plugin issues -->
<!-- EXTRACTED TO: docs/09-troubleshooting/ (when created) -->
