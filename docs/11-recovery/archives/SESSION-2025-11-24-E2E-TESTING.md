...
- [`docs/07-content-manager/POPULATE_TEST_DATA_GUIDE.md`](/docs/docs-07-content-manager-populate_test_data_guide) - Test data population
- [`apps/ui/e2e/README.md`](/docs/readme) - E2E test suite guide
- [`docs/08-devops/ci-cd-e2e-testing.md`](/docs/08-devops-ci-cd-e2e-testing) - CI/CD integration
- [`apps/ui/E2E_TESTING.md`](/docs/apps-ui-e2e_testing) - Quick start guide
