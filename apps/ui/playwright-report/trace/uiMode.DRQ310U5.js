const __vite__mapDeps = (
  ...
  m = __vite__mapDeps,
  d = m.f ||
    (m.f = ["./assets/xtermModule-CsJ4vdCR.js", "./xtermModule.DYP7pi_n.css"])
) => i.map((i) => d[i])
import {
  u as At,
  r as K,
...
class dt {
  ...
  _mergeSuiteInto(t, e) {
    ...
    s ||
      ((s = new X(t.title, e.type === "project" ? "file" : "describe")),
      e._addSuite(s)),
...
class ut {
  constructor(t, e, s, i, d, n) {
    ...
    const c = (f, a, w, x) => {
      for (const l of x === "tests" ? [] : a.suites) {
        ...
        let T = w.children.find(
          (_) => _.kind === "group" && _.title === l.title
        )
        T ||
          ((T = {
            kind: "group",
  ...
  filterTree(t, e, s) {
    const i = t.trim().toLowerCase().split(" "),
      ...
      n = (c) => {
        const f = [...c.tests[0].titlePath(), ...c.tests[0].tags]
          .join(" ")
          .toLowerCase()
        return !i.every((a) => f.includes(a)) &&
          ...
          : ((c.children = c.children.filter(
              (a) =>
                !d || (s == null ? void 0 : s.has(a.test.id)) || e.get(a.status)
            )),
...
function Tt(o) {
  ...
  o.kind === "group" &&
    o.children.sort(
      (n, m) =>
        n.location.file.localeCompare(m.location.file) ||
        n.location.line - m.location.line
    )
      ...
      K.useEffect(() => {
        setTimeout(() => {
          n.current &&
            ...
            o.resize(n.current.terminal.cols, n.current.terminal.rows))
        }, 250)
      }, [t, o]),
      r.jsx("div", {
        "data-testid": "output",
        ...
        S.children.forEach(E),
          !h &&
            ...
            ((S.kind === "test" && d.testIds.has(S.test.id)) ||
              (S.kind === "case" &&
                d.testIds.has((M = S.tests[0]) == null ? void 0 : M.id))) &&
            (h = S)
      }
          ...
          children: [
            r.jsxs("div", {
              ...
              children: [
                ...
                h.kind === "case"
                  ? h.tags.map((Y) =>
                      r.jsx(pe, { tag: Y.slice(1), onClick: (G) => q(G, Y) }, Y)
                    )
                  : null,
              ],
            }),
...
const be = ({
    ...
    return (
      u.useEffect(() => {
        ...
        const T =
          l && l.duration >= 0 && l.attachments.find((k) => k.name === "trace")
        if (T && T.path) {
      ...
      r.jsx(
        Yt,
        {
          ...
          annotations:
            ((x = o.testCase) == null ? void 0 : x.annotations) ?? [],
          onOpenExternally: e,
          revealSource: s,
        },
        "workbench"
    ...
    u.useEffect(() => {
      ...
      u.useEffect(() => {
        ...
        return (
          (z.resize = (g, j) => {
            ;(wt = { cols: g, rows: j }),
              v.resizeTerminalNoReply({ cols: g, rows: j })
          }),
          () => {
...
`
      ...
      u.useEffect(() => {
        ...
        const { config: p, rootSuite: g } = a,
          j = p.configFile
            ? xt.getObject(p.configFile + ":projects", void 0)
            : void 0,
          I = new Map(c)
        for (const P of I.keys())
          g.suites.find((U) => U.title === P) || I.delete(P)
    ...
    const { testTree: Mt } = u.useMemo(() => {
        if (!a)
          return {
            testTree: new ut("", new X("", "root"), [], c, B.pathSeparator, Q),
          }
        ...
        (p, g) => {
          !v ||
            ...
            (E.current = E.current.then(async () => {
              ...
              {
                for (const y of ((P = a.rootSuite) == null
                  ? void 0
                  : P.allTests()) || [])
                  if (j.has(y.id)) {
                    y.results = []
              ...
              z.write(
                "\x1B[2m—".repeat(Math.max(0, wt.cols - I.length)) +
                  I +
                  "\x1B[22m"
              ),
              ...
              for (const y of ((U = a.rootSuite) == null
                ? void 0
                : U.allTests()) || [])
                ((F = y.results[0]) == null ? void 0 : F.duration) === -1 &&
                  (y.results = [])
    ...
    const lt = u.useRef(null),
      Ft = u.useCallback((p) => {
        ...
        p.preventDefault(),
          p.stopPropagation(),
          (g = lt.current) == null || g.showModal()
      }, []),
      ct = u.useCallback((p) => {
        var g
        p.preventDefault(),
          p.stopPropagation(),
          (g = lt.current) == null || g.close()
      }, []),
      Ot = u.useCallback(
        (p) => {
          ct(p),
            ...
            children: [
              ...
              r.jsx("div", {
                ...
                children: r.jsx(be, {
                  ...
                  item: T,
                  rootDir:
                    (_t = a == null ? void 0 : a.config) == null
                      ? void 0
                      : _t.rootDir,
                  revealSource: Ct,
                  onOpenExternally: (p) =>
