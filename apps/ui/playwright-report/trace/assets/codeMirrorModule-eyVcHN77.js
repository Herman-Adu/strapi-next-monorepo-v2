        ...
        ;(function (C, De) {
          ...
          var C = navigator.userAgent,
            ...
            ne =
              te ||
              re ||
              /webOS|BlackBerry|Opera Mini|Opera Mobi|IEMobile/i.test(C),
            se = te || /Mac/.test(De),
            Ae = /\bCrOS\b/.test(C),
            ye = /win/i.test(De),
          ...
          var mi = (function () {
            ...
            return function (u, h) {
              ...
              for (var k = u.length, x = [], M = 0; M < k; ++M)
                x.push(n(u.charCodeAt(M)))
              ...
              for (var gt = [], Jt, ut = 0; ut < k; )
                if (l.test(x[ut])) {
                  ...
                  for (var mt = ir; mt < ut; )
                    if (a.test(x[mt])) {
                      ir < mt &&
                        (gt.splice(Ar, 0, new s(1, ir, mt)), (Ar += Er))
                      var on = mt
              ...
              return (
                h == "ltr" &&
                  (gt[0].level == 1 &&
                    (Jt = u.match(/^\s+/)) &&
                    ((gt[0].from = Jt[0].length),
                    gt.unshift(new s(0, 0, Jt[0].length))),
                  ge(gt).level == 1 &&
                    (Jt = u.match(/\s+$/)) &&
                    ((ge(gt).to -= Jt[0].length),
                    gt.push(new s(0, k - Jt[0].length, k)))),
                h == "rtl" ? gt.reverse() : gt
              )
            }
          })()
            ...
            if (Or == null) {
              ...
              J(e, d("span", [t, document.createTextNode("x")])),
                e.firstChild.offsetHeight != 0 &&
                  (Or =
                    t.offsetWidth <= 1 && t.offsetHeight > 2 && !(b && N < 8))
            }
            var n = Or
              ? d("span", "​")
              : d(
          ...
          function sr(e) {
            ...
            return (
              D(e), !n || n.left == n.right ? !1 : (an = r.right - n.right < 3)
            )
          }
          var Pt =
              `
...
`,
          ...
          ;(Je.prototype.eol = function () {
            ...
            (Je.prototype.column = function () {
              return (
                ...
                this.lastColumnValue -
                  (this.lineStart
                    ? Le(this.string, this.lineStart, this.tabSize)
                    : 0)
              )
            }),
          ...
          function f(e) {
            ...
            for (
              var t = e.parent, n = oe(t.lines, e), r = t.parent;
              r;
              t = r, r = r.parent
            )
          ...
          function Ce(e, t) {
            ...
            return t.line > n
              ? L(n, ce(e, n).text.length)
              : _a(t, ce(e, t.line).text.length)
          }
          function _a(e, t) {
            var n = e.ch
                  ...
                  ;(n.state = !0),
                    wo(
                      ...
                      function (x, M) {
                        for (var E = v; k < x; ) {
                          var R = i[v]
                          R > x && i.splice(v, 1, x, i[v + 1], R),
                            (v += 2),
                            (k = Math.min(x, R))
                        }
                        if (M)
                          if (h.opaque)
                            i.splice(E, v - E, x, "overlay " + M), (v = E + 2)
                          else
                            for (; E < v; E += 2) {
                              var U = i[E + 1]
                              i[E + 1] = (U ? U + " " : "") + "overlay " + M
          ...
          function bi(e, t, n, r) {
            ...
            for (
              o.start = o.pos = r || 0, t == "" && yo(i, n.state);
              !o.eol();
          ...
          function Ha(e, t, n) {
            for (
              ...
              if (
                u &&
                (!n ||
                  a + (u instanceof Hn ? u.lookAhead : 0) <= o.modeFrontier)
              )
                return a
            ...
            if (e)
              for (var i = 0; i < e.length; ++i) {
                ...
                if (
                  ...
                  var s =
                    o.to == null || (l.inclusiveRight ? o.to >= t : o.to > t)
            ...
            if (!u) {
              ...
              if (Q > 0 && a)
                for (var ee = 0; ee < a.length; ++ee)
                  a[ee].to == null &&
                    (G || (G = [])).push(new Rn(a[ee].marker, null, null))
          ...
          function No(e, t) {
              ...
              ls(o, r, mo(e, o, a)),
                ...
                r.map.length == 0 &&
                  r.map.push(
                    0,
                    0,
                    r.content.appendChild(Wn(e.display.measure))
                  ),
                i == 0
            ...
            return (
              ...
              r.pre.className &&
                (r.textClass = le(r.pre.className, r.textClass || "")),
              r
            )
          }
          function rs(e) {
...
`
            ...
            for (
              ...
              if (x == s) {
                ...
                for (var G = [], ee = void 0, me = 0; me < r.length; ++me) {
                  var pe = r[me],
                    Fe = pe.marker
                  if (Fe.type == "bookmark" && pe.from == s && Fe.widgetNode)
                    G.push(Fe)
                  else if (
                    pe.from <= s &&
                    (pe.to == null ||
                      pe.to > s ||
                      (Fe.collapsed && pe.to == s && pe.from == s))
                  ) {
                    if (
                      (pe.to != null &&
                        pe.to != s &&
                      ...
                      Fe.endStyle &&
                        pe.to == x &&
                        (ee || (ee = [])).push(Fe.endStyle, pe.to),
                      Fe.title && ((Q || (Q = {})).title = Fe.title),
                      Fe.attributes)
                    )
                      for (var Ke in Fe.attributes)
                        (Q || (Q = {}))[Ke] = Fe.attributes[Ke]
                    Fe.collapsed && (!U || Si(U.marker, Fe) < 0) && (U = pe)
                  } else pe.from > s && x > pe.from && (x = pe.from)
                }
                if (ee)
                  for (var st = 0; st < ee.length; st += 2)
                    ee[st + 1] == x && (E += " " + ee[st])
                if (!U || U.from == s)
                  for (var Xe = 0; Xe < G.length; ++Xe) Oo(t, 0, G[Xe])
                if (U && (U.from || 0) == s) {
                  if (
                    (Oo(
                      t,
                      (U.to == null ? a + 1 : U.to) - s,
                      U.marker,
                      U.from == null
                    ),
                    U.to == null)
          ...
          function qr(e, t) {
            ...
            r && !r.text
              ...
              : r &&
                r.changes &&
                (Io(e, r, n, Ii(e)), (e.curOp.forceUpdate = !0)),
              r || (r = ms(e, t))
            var i = Ro(r, t, n)
            return {
              line: t,
            ...
            if (o.nodeType == 3) {
              for (var h = 0; h < 4; h++) {
                ...
                for (
                  ...
                  Me(t.line.text.charAt(i.coverStart + a));
          ...
          function Ei(e) {
            var t = qt(e),
              ...
              r = 0
            if (n)
              for (var i = 0; i < n.length; ++i) n[i].above && (r += pn(n[i]))
            return r
          }
          ...
          function Jo(e, t) {
            var n = 0
            ;(t = Ce(e.doc, t)),
              e.options.lineWrapping || (n = Kr(e.display) * t.ch)
          ...
          function Oi(e, t, n) {
            ...
            var i = g(r, n),
              o = r.first + r.size - 1
            if (i > o)
              return Ni(r.first + r.size - 1, ce(r, o).text.length, null, 1, 1)
            t < 0 && (t = 0)
            for (var l = ce(r, i); ; ) {
              var a = ks(e, l, i, t, n),
            ...
            var a = Nt(
                function (v) {
                  ...
                  return Pi(
                    jt(
                      e,
                      L(n, x ? k.to : k.from, x ? "before" : "after"),
                      "line",
                      t,
                      r
                    ),
              ...
              if (!(x.from >= u || x.to <= s)) {
                var M = x.level != 1,
                  E = Zt(
                    e,
                    r,
                    M ? Math.min(u, x.to) - 1 : Math.max(s, x.from)
                  ).right,
                  R = E < o ? o - E + 1e9 : E - o
                ;(!h || v > R) && ((h = x), (v = R))
              }
          ...
          function $o(e) {
            var t = jr(e.display),
              ...
              r =
                n &&
                Math.max(5, e.display.scroller.clientWidth / Kr(e.display) - 3)
            return function (i) {
          ...
          function Tr(e, t, n, r) {
            var i = e.display
            if (!n && ln(t).getAttribute("cm-not-content") == "true")
              return null
            var o,
              l,
            ...
            if (
              r &&
              s.xRel > 0 &&
              (u = ce(e.doc, s.line).text).length == s.ch
            ) {
              ...
              s = L(
                ...
                Math.max(
                  0,
                  Math.round((o - Ho(e.display).left) / Kr(e.display)) - h
                )
              )
            }
            return s
              ...
              if (!(!t && a == n.sel.primIndex)) {
                ...
                if (
                  ...
                  if (l) {
                    ...
                    (u || e.options.showCursorWhenSelecting) && Wi(e, s.head, i)
                  u || Ls(e, s, o)
                }
              }
            return r
          ...
          function Ls(e, t, n) {
            ...
            if (k.line == x.line) v(k.line, k.ch, x.ch)
              ...
              R &&
                (U.top < Q.top - 2
                  ? (h(U.right, U.top, null, U.bottom),
                    h(a, Q.top, Q.left, Q.bottom))
                ...
                if (((i += a.line.height), b && N < 8)) {
                  ...
                  ;(u = k.bottom - k.top),
                    !s &&
                      a.text.firstChild &&
                      (h =
                        a.text.firstChild.getBoundingClientRect().right -
                        k.left -
                        1)
                }
          ...
          function Ds(e, t, n, r) {
            ...
            for (var o = 0; o < 5; o++) {
              ...
              if (
                (u.scrollTop != null &&
                  (yn(e, u.scrollTop),
                  Math.abs(e.doc.scrollTop - h) > 1 && (l = !0)),
                u.scrollLeft != null &&
                  (Cr(e, u.scrollLeft),
          ...
          function Ps(e) {
            ...
            e.updatedDisplay && Vn(t),
              ...
              n.maxLineChanged &&
                ...
                ((e.adjustWidthTo =
                  qo(t, n.maxLine, n.maxLine.text.length).left + 3),
          ...
          function kn(e, t) {
            e.doc.highlightFrontier < e.display.viewTo &&
              e.state.highlight.set(t, ue(Bs, e))
          }
          function Bs(e) {
            var t = e.doc
              ...
              if (!r || !e.options.lineWrapping || t.oldDisplayWidth == wr(e)) {
                if (
                  (n &&
                    ...
                    (n = {
                      top: Math.min(
                        e.doc.height + Mi(e.display) - Fi(e),
                        n.top
                      ),
                    }),
            ...
            for (var s = r.view, u = r.viewFrom, h = 0; h < s.length; h++) {
              ...
              if (!v.hidden)
                if (!v.node || v.node.parentNode != o) {
                  ...
                  v.changes &&
                    (oe(v.changes, "gutter") > -1 && (x = !1), Io(e, v, u, n)),
                    x &&
                      (D(v.lineNumber),
          ...
          function Xi(e, t) {
            ;(e.display.sizer.style.minHeight = t.docHeight + "px"),
              ...
              (e.display.gutters.style.height =
                t.docHeight + e.display.barHeight + Yt(e) + "px")
          }
          function fl(e) {
            var t = e.display,
              n = t.view
          ...
          function cl(e) {
            ...
            if (n.length != r.lineNumChars) {
              ...
              return (
                ...
                (r.lineNumInnerWidth =
                  Math.max(o, r.lineGutter.offsetWidth - l) + 1),
                    ...
                    setTimeout(function () {
                      if (l.wheelStartX != null) {
                        var R = a.scrollLeft - l.wheelStartX,
                          ...
                          Q =
                            (U && l.wheelDY && U / l.wheelDY) ||
                            (R && l.wheelDX && R / l.wheelDX)
          ...
          ;(At.prototype.primary = function () {
            ...
            (At.prototype.deepCopy = function () {
              for (var e = [], t = 0; t < this.ranges.length; t++)
                e[t] = new He(
                  it(this.ranges[t].anchor),
                  it(this.ranges[t].head)
                )
          ...
          function Qi(e, t, n, r) {
            ...
            function l(Q, G) {
              for (var ee = [], me = Q; me < G; ++me)
                ee.push(new Hr(u[me], i(me), r))
              return ee
            }
            var a = t.from,
              s = t.to,
            ...
            if (t.full)
              ...
              if (u.length == 1)
                o(h, h.text.slice(0, a.ch) + k + h.text.slice(s.ch), x)
              else {
              ...
              for (var l = 0; l < o.markedSpans.length; ++l) {
                ...
                if (
                  ...
                  if (n) {
                    ...
                    if (
                      ((r < 0 ? h : u) &&
                        (v = Al(e, v, -r, v && v.line == t.line ? o : null)),
                      v &&
                        v.line == t.line &&
                        (k = Z(v, n)) &&
                        (r < 0 ? k < 0 : k > 0))
                  ...
                  return (
                    (r < 0 ? u : h) &&
                      (x = Al(e, x, r, x.line == t.line ? o : null)),
                    x ? Zr(e, x, t, r, i) : null
                  )
                }
              }
          ...
          function Ol(e, t) {
            if (
              ...
              vr(e, function (i, o) {
                !o &&
                  oe(r, i.history) == -1 &&
                  (Bl(i.history, t), r.push(i.history)),
                  Tn(i, t, null, wi(i, t))
              })
            }
          }
            ...
            if (!(r && !n)) {
              ...
              if (u != a.length) {
                ...
                for (
                  var v =
                      Ct(e, "beforeChange") ||
                      (e.cm && Ct(e.cm, "beforeChange")),
                    k = function (E) {
                      var R = o.changes[E]
                      if (((R.origin = t), v && !Nl(e, R, !1)))
                        return (a.length = 0), {}
                      h.push(Vi(e, R))
                      var U = E ? Zi(e, R) : ge(a)
                      Tn(e, R, U, Sl(e, R)),
                        !E &&
                          e.cm &&
                          e.cm.scrollIntoView({ from: R.from, to: gr(R) })
                      var Q = []
                      vr(e, function (G, ee) {
                        !ee &&
                          oe(Q, G.history) == -1 &&
                          (Bl(G.history, R), Q.push(G.history)),
                          Tn(G, R, null, Sl(G, R))
                      })
                    },
          ...
          ;(Mn.prototype.clear = function () {
            ...
            Bt(Mn)
          function Wl(e, t, n) {
            er(t) < ((e.curOp && e.curOp.scrollTop) || e.doc.scrollTop) &&
              ji(e, n)
          }
          function $s(e, t, n, r) {
            var i = new Mn(e, n, r),
            ...
            return (
              ...
              Ln(e, t, "widget", function (l) {
                ...
                if (
                  (i.insertAt == null
                    ? a.push(i)
                    : a.splice(
                        Math.min(a.length, Math.max(0, i.insertAt)),
                        0,
                        i
                      ),
                  (i.line = l),
              ...
              o &&
                ot(o, "lineWidgetAdded", o, i, typeof t == "number" ? t : f(t)),
              i
            )
          }
          var _l = 0,
          ...
          ;(mr.prototype.clear = function () {
            if (!this.explicitlyCleared) {
              ...
              for (var r = null, i = null, o = 0; o < this.lines.length; ++o) {
                ...
                e && !this.collapsed
                  ? dr(e, f(l), "text")
                  : e &&
                    (a.to != null && (i = f(l)), a.from != null && (r = f(l))),
            ...
            (mr.prototype.find = function (e, t) {
              ...
              for (var n, r, i = 0; i < this.lines.length; ++i) {
                ...
                if (l.from != null && ((n = L(t ? o : f(o), l.from)), e == -1))
                  return n
                if (l.to != null && ((r = L(t ? o : f(o), l.to)), e == 1))
                  return r
              }
            ...
            (mr.prototype.attachLine = function (e) {
              if (!this.lines.length && this.doc.cm) {
                ...
                ;(!t.maybeHiddenMarkers ||
                  oe(t.maybeHiddenMarkers, this) == -1) &&
                  (
            ...
            (mr.prototype.detachLine = function (e) {
              if (
                (this.lines.splice(oe(this.lines, e), 1),
          ...
          function Vr(e, t, n, r, i) {
            ...
            var o = new mr(e, i),
              l = Z(t, n)
            if (
              (r && Te(r, o, !1), l > 0 || (l == 0 && o.clearWhenEmpty !== !1))
            )
              return o
            if (
              (o.replacedWith &&
              ...
              if (
                Fo(e, t.line, t, n, o) ||
                (t.line != n.line && Fo(e, n.line, t, n, o))
              )
                throw new Error(
            ...
            o.addToHistory &&
              kl(e, { from: t, to: n, origin: "markText" }, e.sel, NaN)
            var a = t.line,
              s = e.cm,
              u
            if (
          ...
          ;(kt.prototype = F(Dn.prototype, {
            ...
            setCursor: at(function (e, t, n) {
              Ll(
                this,
                Ce(this, typeof e == "number" ? L(e, t || 0) : e),
                null,
                n
              )
            }),
            ...
            replaceSelections: at(function (e, t, n) {
              ...
              for (
                var a = t && t != "end" && Ks(this, r, t), s = r.length - 1;
                s >= 0;
                s--
              )
                Jr(this, r[s])
...
`
                      ...
                      a = function () {
                        ++l == i &&
                          lt(t, function () {
                            ...
                            Jr(t.doc, x),
                              Cl(t.doc, pr(Ce(t.doc, n), Ce(t.doc, gr(x))))
                          })()
                      },
                      s = function (x, M) {
                        if (
          ...
          function ro(e, t, n) {
            ...
            return r == null
              ? null
              : new L(t.line, r, n < 0 ? "after" : "before")
          }
          ...
          function du(e, t, n, r) {
            ...
            if (e.doc.direction == "rtl" || l.level == 1) {
              ...
              if (
                k != null &&
                (v ? k <= l.to && k <= h.end : k >= l.from && k >= h.begin)
              ) {
              ...
              return Dt(e, function () {
                for (
                  ...
                  if (t[r].empty()) {
                    ...
                    if (o) {
                      if (
                        (i.ch == o.length && (i = new L(i.line, i.ch - 1)),
                        i.ch > 0)
                      )
...
`,
                  ...
                  !(r && bu(t, i, r, o, e)) &&
                    (i == 1
                      ...
                      : i == 2
                        ...
                        : i == 3 &&
                          (fe ? t.display.input.onContextMenu(e) : Hi(t)))
              }
            }
          }
          ...
          function ku(e, t, n) {
            ...
            return (
              ...
              i.moveOnDrag == null &&
                (i.moveOnDrag = !(se ? n.altKey : n.ctrlKey)),
              i
            )
          }
          function wu(e, t, n, r) {
          ...
          function ra(e, t, n) {
            ...
            if (n == "line")
              return new He(L(t.line, 0), Ce(e.doc, L(t.line + 1, 0)))
            var r = n(e, t)
                ...
                if (((v = G), r.unit == "rectangle")) {
                  for (
                    ...
                    Ke == st
                      ...
                      : wt.length > tt &&
                        ee.push(new He(L(Xe, tt), L(Xe, Re(wt, st, me))))
                  }
            ...
            function E(G) {
              ...
              if (me)
                if (Z(me, v) != 0) {
                  ...
                  var Fe =
                    G.clientY < x.top ? -20 : G.clientY > x.bottom ? 20 : 0
                  Fe &&
                    setTimeout(
                      lt(e, function () {
          ...
          function Lu(e, t) {
            ...
            var k = o[s + (u ? -1 : 0)],
              ...
              M = x ? k.from : k.to,
              E = x ? "after" : "before"
            return n.ch == M && n.sticky == E
              ? t
              : new He(new L(n.line, M, E), r)
          }
          function na(e, t, n, r) {
            var i, o
            if (t.touches)
          ...
          function Du(e) {
            ...
            ;(e.defineOption = n),
              ...
              n("keyMap", "default", function (r, i, o) {
                var l = fi(i),
                  a = o != tn && fi(o)
                a && a.detach && a.detach(r, l),
                  l.attach && l.attach(r, a || null)
              }),
              n("extraKeys", null),
          ...
          function zn(e, t, n, r) {
            ...
            n == null && (n = "add"),
              n == "smart" &&
                (i.mode.indent ? (o = fn(e, t).state) : (n = "prev"))
            ...
            if ((k < h && (v += et(h - k)), v != u))
              return (
                Qr(i, v, L(t, 0), L(t, u.length), "+input"),
                (a.stateAfter = null),
                !0
              )
...
`) == t
                ...
                if (r.ranges.length % Ut.text.length == 0) {
                  u = []
                  for (var h = 0; h < Ut.text.length; h++)
                    u.push(o.splitLines(Ut.text[h]))
                }
              } else
            ...
            for (
              var v = e.curOp.updateInput, k = r.ranges.length - 1;
              k >= 0;
              k--
            ) {
              var x = r.ranges[k],
              ...
              x.empty() &&
                (n && n > 0
                  ...
                  : e.state.overwrite && !a
                    ? (E = L(
                        E.line,
                        Math.min(ce(o, E.line).text.length, E.ch + ge(s).length)
                      ))
                    : a &&
                      Ut &&
                      Ut.lineWise &&
...
`) &&
              ...
              var R = {
                ...
                origin:
                  i ||
                  (a ? "paste" : e.state.cutIncoming > l ? "cut" : "+input"),
              }
          ...
          function Eu(e) {
            ...
            ;(e.prototype = {
              ...
              indentSelection: vt(function (r) {
                for (
                  var i = this.doc.sel.ranges, o = -1, l = 0;
                  l < i.length;
                  l++
                ) {
                  var a = i[l]
              ...
              moveV: vt(function (r, i) {
                ...
                if (
                  (l.extendSelectionsBy(function (h) {
                    ...
                    h.goalColumn != null && (v.left = h.goalColumn),
                      a.push(v.left)
                    var k = ca(o, v, r, i)
                    return (
                      i == "page" &&
                        h == l.sel.primary() &&
                        ji(o, Zn(o, k, "div").top - v.top),
                      k
                    )
                  }, Oe),
                  a.length)
              ...
              if (r == "codepoint") {
                ...
                if (isNaN(ee)) G = null
                  ...
                  G = new L(
                    ...
                    Math.max(
                      0,
                      Math.min(a.text.length, t.ch + n * (me ? 2 : 1))
                    ),
                    -n
                  )
                }
...
`))
            ...
            (je.prototype.pollContent = function () {
              ...
              for (
                ...
                M < ee &&
                Q.charCodeAt(Q.length - M - 1) ==
                  G.charCodeAt(G.length - M - 1);
              ...
              if (v.length > 1 || v[0] || Z(me, pe))
                return Qr(e.doc, v, me, pe, "+input"), !0
            }),
          ...
          function Pu(e, t, n) {
            ...
            if (v) return rn(v, i)
            for (
              var k = a.nextSibling, x = l ? l.nodeValue.length - n : 0;
              k;
              k = k.nextSibling
            ) {
              if (((v = h(k, k.firstChild, 0)), v))
                return rn(L(v.line, v.ch - x), i)
              x += k.textContent.length
            }
            for (var M = a.previousSibling, E = n; M; M = M.previousSibling) {
              if (((v = h(M, M.firstChild, -1)), v))
          ...
          ;($e.prototype.init = function (e) {
            ...
            e.wrapper.insertBefore(this.wrapper, e.wrapper.firstChild),
              ...
              ve(i, "input", function () {
                b && N >= 9 && t.hasSelection && (t.hasSelection = null),
                  n.poll()
              }),
...
`) > -1
      ...
      outline: none; border-width: 0; outline: none; overflow: hidden; opacity: .05; filter: alpha(opacity=5);`)
          ...
          function Iu(e, t) {
            ...
            if (
              e.form &&
              (ve(e.form, "submit", r), !t.leaveSubmitMethodAlone)
            ) {
              var o = e.form
              i = o.submit
              try {
        ...
        ;(function (C) {
          ...
          C.defineMode("css", function (fe, H) {
            ...
            function Ne(T, B) {
              ...
              if (F == "@")
                return T.eatWhile(/[\w\\\-]/), oe("def", T.current())
              if (F == "=" || ((F == "~" || F == "|") && T.eat("=")))
                return oe(null, "compare")
              if (F == '"' || F == "'")
                return (B.tokenize = qe(F)), B.tokenize(T, B)
              if (F == "#") return T.eatWhile(/[\w\\\-]/), oe("atom", "hash")
              if (F == "!")
                return T.match(/^\s*\w*/), oe("keyword", "important")
            ...
            return (
              (Pe.top = function (T, B, F) {
                ...
                if (ue && /@component/i.test(T))
                  return Oe(F, B, "atComponentBlock")
                if (/^@(-moz-)?document$/i.test(T))
                  return Oe(F, B, "documentTypes")
                  ...
                  return (
                    ...
                    F.prev &&
                      ...
                      (F.type == "block" ||
                        ...
                        : ((Ie == ")" &&
                            (F.type == "parens" ||
                              F.type == "atBlock_parens")) ||
                            (Ie == "{" &&
                              (F.type == "at" || F.type == "atBlock"))) &&
          ...
          function De(fe) {
            for (var H = {}, Ee = 0; Ee < fe.length; ++Ee)
              H[fe[Ee].toLowerCase()] = !0
            return H
          }
          ...
          C.defineMode("xml", function (K, $) {
            ...
            function we(d) {
              return function (S, w) {
                for (var m; (m = S.next()) != null; ) {
                  if (m == "<")
                    return (w.tokenize = we(d + 1)), w.tokenize(S, w)
                  if (m == ">")
                    if (d == 1) {
                      w.tokenize = q
                      break
            ...
            function re(d, S, w) {
              ;(this.prev = d.context),
                ...
                (this.startOfLine = w),
                (b.doNotIndent.hasOwnProperty(S) ||
            ...
            function Ee(d, S, w) {
              return d == "equals"
                ? D
                : (b.allowMissing || (O = "error"), H(d, S, w))
            }
            function D(d, S, w) {
              return d == "string"
                ? J
                ...
                if (y && y[1])
                  for (; m; )
                    if (m.tagName == y[2]) {
                      m = m.prev
                      break
                    } else if (b.implicitlyClosed.hasOwnProperty(te(m.tagName)))
                      m = m.prev
                    else break
                else if (y)
                  for (; m; ) {
        ...
        ;(function (C) {
          ...
          C.defineMode("javascript", function (De, I) {
            ...
            function re(f, g) {
              var A = f.next()
              if (A == '"' || A == "'")
                return (g.tokenize = ne(A)), g.tokenize(f, g)
              ...
              if (A == "#" && f.peek() == "!")
                return f.skipToEnd(), te("meta", "meta")
              ...
              if (q.test(A))
                return (
                  ...
                  A == "?" && f.eat(".")
                    ? te(".")
                    : te("operator", "operator", f.current())
                )
              if (ie.test(A)) {
                f.eatWhile(ie)
                var W = f.current()
            ...
            function w(f) {
              ...
              if (((D.marked = "def"), !!N)) {
                ...
                I.globalVars &&
                  !S(f, g.globalVars) &&
                  (g.globalVars = new le(f, g.globalVars))
              }
            }
            function m(f, g) {
              if (g)
                if (g.block) {
                  ...
                  return S(f, g.vars) ? g : new P(g.prev, new le(f, g.vars), !1)
              else return null
            }
            function y(f) {
              return (
            ...
            function et(f) {
              if (f == "}")
                return (D.marked = "string-2"), (D.state.tokenize = Ae), d(Ue)
            }
            function ge(f) {
            ...
            function Se(f, g) {
              ...
              if (f == "variable" || D.style == "keyword") {
                if (((D.marked = "property"), g == "get" || g == "set"))
                  return d(he)
                var A
                return (
                  _ &&
                ...
                if (f == "number" || f == "string")
                  return (
                    (D.marked = V ? "property" : D.style + " property"), d(Be)
                  )
            ...
            function lr(f) {
              if (_ && f == ":")
                return D.stream.match(/^\s*\w+\s+is\b/, !1)
                  ? d(oe, mi, We)
                  : d(We)
            }
            function mi(f, g) {
            ...
            function Ye(f) {
              if (f == "}")
                return (D.marked = "string-2"), (D.state.tokenize = Ae), d(dt)
            }
            function Ze(f, g) {
            ...
            C.defineMIME("application/x-json", {
              name: "javascript",
              json: !0,
            }),
            C.defineMIME("application/manifest+json", {
              name: "javascript",
              json: !0,
            }),
            C.defineMIME("application/ld+json", {
              name: "javascript",
              jsonld: !0,
            }),
            C.defineMIME("text/typescript", {
              name: "javascript",
              typescript: !0,
            }),
            C.defineMIME("application/typescript", {
              name: "javascript",
              typescript: !0,
            })
        })
      ...
      (function (Et, zt) {
        ;(function (C) {
          ...
          function I(ie, O, q) {
            ...
            return (
              X > -1
                ...
                : z.match(/<\/?$/) &&
                  (ie.backUp(z.length), ie.match(O, !1) || ie.match(z)),
              q
            )
          }
          var K = {}
          ...
          function N(ie, O) {
            for (var q in ie)
              for (
                var z = O[q] || (O[q] = []), X = ie[q], ke = X.length - 1;
                ke >= 0;
                ke--
              )
                z.unshift(X[ke])
              ...
              function te(re, ne) {
                ...
                if (
                  ...
                  (ye =
                    ...
                    ne.htmlState.tagName.toLowerCase()) &&
                  z.hasOwnProperty(ye)
                )
                  ne.inTag = ye + " "
                  ...
                  ;(ne.token = function (D, J) {
                    return D.match(H, !1)
                      ? ((J.token = te),
                        (J.localState = J.localMode = null),
                        null)
                      : I(D, Ee, J.localMode.token(D, J.localState))
                  }),
                    (ne.localMode = fe),
                    (ne.localState = C.startState(
                      fe,
                      q.indent(ne.htmlState, "", "")
                    ))
                } else
                  ne.inTag &&
                    ((ne.inTag += re.current()), re.eol() && (ne.inTag += " "))
                return se
              }
              return {
                startState: function () {
                ...
                copyState: function (re) {
                  ...
                  return (
                    re.localState &&
                      (ne = C.copyState(re.localMode, re.localState)),
                    {
                      token: re.token,
                      inTag: re.inTag,
                ...
                innerMode: function (re) {
                  return {
                    state: re.localState || re.htmlState,
                    mode: re.localMode || q,
                  }
                },
              }
          ...
          C.defineMode("python", function (N, _) {
            ...
            function de(S, w, m) {
              ...
              if (S.match(ne)) {
                ...
                return le
                  ? ((w.tokenize = ze(S.current(), w.tokenize)),
                    w.tokenize(S, w))
                  : ((w.tokenize = fe(S.current(), w.tokenize)),
                    w.tokenize(S, w))
              }
              for (var p = 0; p < q.length; p++)
                if (S.match(q[p])) return "operator"
              return S.match(O)
                ? "punctuation"
              ...
              function le(p, c) {
                for (; !p.eol(); )
                  if ((p.eatWhile(/[^'"\{\}\\]/), p.eat("\\"))) {
                    ...
                    if (p.match("{", !1))
                      return (
                        (c.tokenize = P(0)), p.current() ? y : c.tokenize(p, c)
                      )
                    if (p.match("}}")) return y
            ...
            function H(S) {
              ...
              S.scopes.push({
                offset: V(S).offset + N.indentUnit,
                type: "py",
                align: null,
              })
            }
            ...
            function D(S, w) {
              for (
                var m = S.indentation();
                w.scopes.length > 1 && V(w).offset > m;
        ...
        ;(function (C) {
          ...
          C.defineMode("clike", function (m, y) {
            ...
            function T(ae, Se) {
              ...
              if (he == '"' || he == "'")
                return (Se.tokenize = B(he)), Se.tokenize(ae, Se)
              if (ct.test(he)) {
            ...
            return {
              ...
              token: function (ae, Se) {
                ...
                if (
                  ...
                  for (he.type == "}" && (he = K(Se)); he.type == "statement"; )
                    he = K(Se)
                } else
                  ge == he.type
                    ? K(Se)
              ...
              indent: function (ae, Se) {
                ...
                var he = ae.context,
                  ...
                  Me = Be == he.type
                if (
                  (he.type == "statement" && Be == "}" && (he = he.prev),
                  y.dontIndentStatements)
                )
                  for (
                    ;
                    he.type == "statement" &&
                    y.dontIndentStatements.test(he.info);
          ...
          function b(m) {
            for (var y = {}, P = m.split(" "), le = 0; le < P.length; ++le)
              y[P[le]] = !0
            return y
          }
          function N(m, y) {
          ...
          function de(m, y) {
            if ((m.backUp(1), m.match(/^(?:R|u8R|uR|UR|LR)/))) {
              ...
              return P
                ? ((y.cpp11RawStringDelim = P[1]), (y.tokenize = H), H(m, y))
                : !1
            }
          ...
          function Ee(m, y) {
            ...
            le(y.keywords),
              ...
              le(y.atoms),
              P.length &&
                ((y.helperType = m[0]), C.registerHelper("hintWords", m[0], P))
          ...
          Ee("text/x-kotlin", {
            ...
            hooks: {
              ...
              indent: function (m, y, P, le) {
                var p = P && P.charAt(0)
                if ((m.prevToken == "}" || m.prevToken == ")") && P == "")
                  return m.indented
                if (
                  (m.prevToken == "operator" &&
                    P != "}" &&
                    m.context.type != "}") ||
                ...
                if (y.align && y.type == "}")
                  return (
                    y.indented +
                    (m.context.type == (P || "").charAt(0) ? 0 : le)
                  )
              },
            },
            ...
            Ee("text/x-objectivec", {
              ...
              defKeywords: b(
                re + " @interface @implementation @protocol @class"
              ),
          ...
          Ee("text/x-ceylon", {
            ...
            hooks: {
              ...
              token: function (m, y, P) {
                if ((P == "variable" || P == "type") && y.prevToken == ".")
                  return "variable-2"
              },
            },
            modeProps: {
        ...
        ;(function (C) {
          ...
          ;(C.findModeByMIME = function (K) {
            ...
            for (var $ = 0; $ < C.modeInfo.length; $++) {
              ...
              if (V.mimes) {
                for (var b = 0; b < V.mimes.length; b++)
                  if (V.mimes[b] == K) return V
              }
            }
            ...
            (C.findModeByExtension = function (K) {
              ...
              for (var $ = 0; $ < C.modeInfo.length; $++) {
                var V = C.modeInfo[$]
                if (V.ext) {
                  for (var b = 0; b < V.ext.length; b++)
                    if (V.ext[b] == K) return V
                }
              }
            }),
        ...
        ;(function (C) {
          ...
          C.defineMode(
            ...
            function (De, I) {
              ...
              for (var N in b)
                b.hasOwnProperty(N) &&
                  I.tokenTypeOverrides[N] &&
                  (b[N] = I.tokenTypeOverrides[N])
              var _ = /^([*\-_])(?:\s*\1){2,}\s*$/,
                ie = /^(?:[*\-+]|^[0-9]+([.)]))\s+/,
                O = /^\[(x| )\](?=\s)/i,
              ...
              function de(p, c) {
                ...
                if (
                  ...
                  ((c.indentationDiff = c.indentation), Te)
                ) {
                  for (
                    c.list = null;
                    be < c.listStack[c.listStack.length - 1];
                ...
                if (
                  ...
                  if (Y && c.indentation <= Le && (qe = p.match(ke, !0)))
                    return (
                      ...
                      (c.localMode =
                        ...
                        V(qe[2] || I.fencedCodeBlockDefaultMode)),
                  ...
                  if (Ne)
                    return (
                      p.skipToEnd(), (c.hr = !0), (c.thisLine.hr = !0), b.hr
                    )
              ...
              function H(p) {
                  ...
                  for (var Y = 0; Y < p.formatting.length; Y++)
                    c.push(b.formatting + "-" + p.formatting[Y]),
                      p.formatting[Y] === "header" &&
                        c.push(
                          b.formatting + "-" + p.formatting[Y] + "-" + p.header
                        ),
                      p.formatting[Y] === "quote" &&
                        (!I.maxBlockquoteDepth ||
                        I.maxBlockquoteDepth >= p.quote
                          ? c.push(
                              b.formatting +
                                "-" +
                                p.formatting[Y] +
                ...
                return (
                  p.trailingSpaceNewLine
                    ...
                    : p.trailingSpace &&
                      c.push(
                        "trailing-space-" + (p.trailingSpace % 2 ? "a" : "b")
                      ),
              ...
              function D(p, c) {
                ...
                if (
                  ...
                  return (
                    I.highlightFormatting && (c.formatting = "header"), H(c)
                  )
                var j = p.next()
                if (c.linkTitle) {
                  c.linkTitle = !1
                ...
                if (j === "`") {
                  var Le = c.formatting
                  I.highlightFormatting && (c.formatting = "code"),
                    p.eatWhile("`")
                  var be = p.current().length
                  if (c.code == 0 && (!c.quote || be == 1))
                    return (c.code = be), H(c)
                  if (be == c.code) {
                    var oe = H(c)
                    return (c.code = 0), oe
                ...
                if (
                  ...
                  return (
                    p.backUp(1), (c.htmlState = C.startState(K)), se(p, c, ze)
                  )
                }
                if (I.xml && j === "<" && p.match(/^\/\w*?>/))
                  return (c.md_inside = !1), "tag"
                if (j === "*" || j === "_") {
                  for (
                    var Oe = 1,
                      Re = p.pos == 1 ? " " : p.string.charAt(p.pos - 2);
                    Oe < 3 && p.eat(j);
                  ...
                  var Ue = p.peek() || " ",
                    et =
                      !/\s/.test(Ue) &&
                      (!te.test(Ue) || /\s/.test(Re) || te.test(Re)),
                    ge =
                      !/\s/.test(Re) &&
                      (!te.test(Re) || /\s/.test(Ue) || te.test(Ue)),
                    Pe = null,
                    T = null
                  if (
                    (Oe % 2 &&
                    ...
                    I.highlightFormatting &&
                      (c.formatting =
                        Pe == null ? "strong" : T == null ? "em" : "strong em"),
                      Pe === !0 && (c.em = j),
                      T === !0 && (c.strong = j)
                    var oe = H(c)
                    return (
                      Pe === !1 && (c.em = !1), T === !1 && (c.strong = !1), oe
                    )
                  }
                ...
                if (
                  ...
                  ;(c.emoji = !0),
                    I.highlightFormatting && (c.formatting = "emoji")
                  var B = H(c)
                  return (c.emoji = !1), B
                }
                return (
              ...
              function w(p) {
                return function (c, Y) {
                  ...
                  if (xe === p) {
                    ;(Y.f = Y.inline = D),
                      I.highlightFormatting && (Y.formatting = "link-string")
                    var j = H(Y)
                ...
                copyState: function (p) {
                  return {
                    ...
                    localState: p.localMode
                      ? C.copyState(p.localMode, p.localState)
                      : null,
                    inline: p.inline,
                    text: p.text,
                    formatting: !1,
                ...
                token: function (p, c) {
                  if (((c.formatting = !1), p != c.thisLine.stream)) {
                    ...
                    if (
                      ...
                      if (
                        ((c.indentation = Y), (c.indentationDiff = null), Y > 0)
                      )
                        return null
                    }
                  }
        ...
        ;(function (C) {
              ...
              if (N.lineCount() == 1) {
                ...
                _ =
                  ie.nodeName == "TEXTAREA"
                    ? !N.getLine(0).length
                    : !/[^\u200b]/.test(
                        ie.querySelector(".CodeMirror-line").textContent
                      )
              }
              _ ? I(N) : De(N)
            }, 20)
          ...
          function V(N) {
            var _ = N.getWrapperElement(),
              ie = b(N)
            ;(_.className =
              _.className.replace(" CodeMirror-empty", "") +
              (ie ? " CodeMirror-empty" : "")),
              ie ? I(N) : De(N)
          }
          function b(N) {
        ...
        ;(function (C) {
            ...
            (C.simpleMode = function (O, q) {
              ...
              var Ae = {
                ...
                copyState: function (de) {
                  ...
                  de.localState &&
                    (ze.localState = C.copyState(de.local.mode, de.localState)),
                  ...
                  for (var fe = de.persistentStates; fe; fe = fe.next)
                    ze.persistentStates = {
                      ...
                      spec: fe.spec,
                      state:
                        fe.state == de.localState
                          ? ze.localState
                          : C.copyState(fe.mode, fe.state),
                ...
                innerMode: function (de) {
                  return (
                    de.local && { mode: de.local.mode, state: de.localState }
                  )
                },
                indent: ie(z, X),
              }
          ...
          function De(O, q) {
            if (!O.hasOwnProperty(q))
              throw new Error("Undefined state " + q + " in simple mode")
          }
          function I(O, q) {
            if (!O) return /(?:)/
            var z = ""
          ...
          function K(O) {
            ...
            for (var q = [], z = 0; z < O.length; z++)
              q.push(O[z] && O[z].replace(/\./g, " "))
            return q
          }
          function $(O, q) {
              ...
              for (var re = O[X.state], ne = 0; ne < re.length; ne++) {
                ...
                if (Ae) {
                  se.data.next
                    ...
                    se.data.indent &&
                      X.indent.push(z.indentation() + q.indentUnit),
                  ...
                  if (
                    ...
                    return (
                      z.backUp(Ae[0].length - (Ae[1] ? Ae[1].length : 0)), ye[0]
                    )
          ...
          function b(O, q) {
            if (O === q) return !0
            if (!O || typeof O != "object" || !q || typeof q != "object")
              return !1
            var z = 0
            for (var X in O)
          ...
          function ie(O, q) {
            return function (z, X, ke) {
              if (z.local && z.local.mode.indent)
                return z.local.mode.indent(z.localState, X, ke)
              if (
                z.indent == null ||
                z.local ||
            ...
            return {
              token: function (K, $) {
                ...
                if (
                  (($.escaped = !1),
                  V == "#" &&
                    (K.pos == 0 || /\s/.test(K.string.charAt(K.pos - 1))))
                )
                  return K.skipToEnd(), "comment"
                if (K.match(/^('([^']|\\.)*'?|"([^"]|\\.)*"?)/)) return "string"
                if ($.literal && K.indentation() > $.keyCol)
                  return K.skipToEnd(), "string"
